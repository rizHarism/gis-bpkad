<section class="content">
    ...
    <div class="container-fluid ">
        <div class="card">
            <h5 class="card-header">Jumlah Aset Gedung</h5>
            <div class="card-body">
                <div class="row mt-2">
                    <div class="col-lg-4 col-6">
                        <!-- small box -->
                        <div class="small-box bg-primary">
                            <div class="inner">
                                ...
                                <p class="fs-3 mt-2">Seluruh Aset Gedung</p>
                            </div>
                            <div class="icon">
                                <i class="fas fa-globe-americas"></i>
                            </div>
                    ...
                    <div class="col-lg-4 col-6">
                        ...
                        <div class="small-box bg-success">
                            <div class="inner">
                                ...
                                <p class="fs-3 mt-2">Aset Gedung Terinventaris</p>
                            </div>
                            <div class="icon">
                                <i class="fas fa-globe-americas"></i>
                            </div>
                    ...
                    <div class="col-lg-4 col-6">
                        ...
                        <div class="small-box bg-danger">
                            <div class="inner">
                                ...
                                <p class="fs-3 mt-2">Aset Gedung Terpetakan</p>
                            </div>
                            <div class="icon">
                                <i class="fas fa-globe-americas"></i>
                            </div>
